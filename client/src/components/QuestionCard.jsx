...
export function QuestionCard({ question, onAnswer, selectedOption, showResult }) {
  return (
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    variant === "default" &&
                      "bg-secondary/40 border-border hover:border-primary/50 hover:bg-secondary/60 active:scale-[0.99]",
                    variant === "selected" &&
                      "bg-primary/20 border-primary text-primary-foreground shadow-[0_0_15px_rgba(124,58,237,0.2)]",
                    variant === "correct" &&
                      "bg-emerald-500/20 border-emerald-500 text-emerald-100 shadow-[0_0_15px_rgba(16,185,129,0.2)]",
                    variant === "wrong" &&
                      "bg-destructive/20 border-destructive text-destructive-foreground shadow-[0_0_15px_rgba(239,68,68,0.2)]",
                    variant === "dimmed" &&
                    ...
                    <span className="flex items-center gap-4">
                      <span
                        className={cn(
                          ...
                          variant === "default" &&
                            "bg-background/50 border-white/10 text-muted-foreground group-hover/btn:border-primary/50 group-hover/btn:text-primary",
                          variant === "selected" &&
                          ...
                          variant === "dimmed" &&
                            "bg-background/30 border-white/5 text-muted-foreground/50",
                        )}
                      >
